...
![alt text](SQL-Course/Assets\1_top_job_by_pay.png)
...
![alt text](SQL-Course/Assets\2_top_jobs_by_pay_&_skill.png)
...
LIMIT
    25;
```
![alt text](SQL-Course/Assets\5_optimal_skills.png)
