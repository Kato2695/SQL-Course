...
![alt text](sql_capstone_project\Assets\1_top_job_by_pay.png)
...
![alt text](sql_capstone_project\Assets\2_top_jobs_by_pay_&_skill.png)
...
LIMIT
    25;
```
![alt text](sql_capstone_project\Assets\5_optimal_skills.png)
